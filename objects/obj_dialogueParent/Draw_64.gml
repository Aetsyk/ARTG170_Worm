if (showingDialogue) {
	...
	var tempPadding = 30;
	var textX = 10;
	var textY = display_get_gui_height() - tempPadding;
	var height = 30;
	var border = 5;
	...
	draw_rectangle(0, (display_get_gui_height() - height - tempPadding), display_get_gui_width(), display_get_gui_height() - tempPadding, false);
	
	draw_set_color(c_white);
	draw_rectangle(border, (display_get_gui_height() - height - tempPadding) + border, display_get_gui_width() - border, display_get_gui_height() + height - border - tempPadding, false);
	
	draw_set_color(c_black);
	draw_rectangle((border * 2), (display_get_gui_height() - height - tempPadding) + (border * 2), display_get_gui_width() - (border) - padding, display_get_gui_height() - tempPadding (border * 2), false);
